/**
@mainpage Data Acquisition GUI
@version 1.0
@author Ken Sarkies (www.jiggerjuice.net)
@date 31 December 2016

This is the PC user interface to the Data Acquisition Unit.

Call with data-acquisition [options]
...
//-----------------------------------------------------------------------------
/** @brief Data Acquisition GUI Main Program
...
// Unknown
    ...
    DataAcquisitionGui DataAcquisitionGui(serialDevice,initialBaudrate);
    if (DataAcquisitionGui.success())
    {
        DataAcquisitionGui.show();
        return application.exec();
    }
    else
        QMessageBox::critical(0,"Unable to connect to remote system",
              QString("%1").arg(DataAcquisitionGui.error()));
    return false;
}
